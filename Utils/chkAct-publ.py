...
def getActivityLog():
    username = st.secrets["SOCRATA_USERNAME"]
    password = st.secrets["SOCRATA_PASSWORD"]

#    "$where": "created_at > '2023-01-01T00:00:00' and acting_user_name = 'Colorado Information Marketplace' order by 'created_at' desc"
    
    # URL of the login form
    query = {
    "$where": "created_at > '2025-01-01T00:00:00' and (acting_user_name = 'Business Intelligence Center of CO')"
    }
    login_url = 'https://data.colorado.gov/api/activity_log.json?$limit=600000'
